...
REM xmltest1.cmd - execute all XML test cases
REM
...
@if NOT EXIST xmlcases.txt goto Err0
...
:ERR0
echo	ERROR: Can not locate 'xmlcases.txt' ... check name, and location ...
goto END
:ERR1
...
@echo	XmlTest1 tidy.exe Out_Folder
...
@echo	==================================
@echo	XMLTEST1.CMD will run a battery of test files in the input folder
@echo	Each test name, has an expected result, given in xmlcases.txt
