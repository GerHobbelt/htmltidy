...
/* fix input encoding based on <meta> tag */
#ifndef AUTO_INPUT_ENCODING
#define AUTO_INPUT_ENCODING 1
#endif

#ifndef TIDY_STORE_ORIGINAL_TEXT
#define TIDY_STORE_ORIGINAL_TEXT 1
#endif
